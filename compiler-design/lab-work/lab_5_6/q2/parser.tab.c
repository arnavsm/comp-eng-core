...
{
  "$end", "error", "$undefined", "DATATYPE", "IDENTIFIER", "UNKNOWN",
  "SEMICOLON", "COMMA", "$accept", "input", "declaration", "$@1",
  "var_list", YY_NULLPTR
};
#endif
...
#line 52 "parser.y" /* yacc.c:1646  */
    { current_datatype = strdup((yyvsp[0].strval)); }
#line 1255 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 53 "parser.y" /* yacc.c:1646  */
    { yyerror("Error: unknown datatype"); }
#line 1261 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 54 "parser.y" /* yacc.c:1646  */
    { yyerror("Error: datatype of identifier missing"); }
