...
static const char *const yytname[] =
{
  ...
  "MULTIPLY", "DIVIDE", "MODULO", "ASSIGN", "LPAREN", "RPAREN", "UNARY",
...
{
       7,     8,     9,     1,     2,     0,     3,    15,    16,    17,
      18,     4,    10,    11,    12,    13,    12,    13,     0,    14,
      10,    11,    12,    13
};
...
{
       0,     3,     4,     6,    11,    15,    16,    16,    16,     0,
       5,     6,     7,     8,    12,    16,    16,    16,    16
};
...
#line 40 "parser.y" /* yacc.c:1646  */
    {
        ...
        generate_code("+", (yyvsp[-2].str), (yyvsp[0].str), result);
        (yyval.str) = result; // Set $$ to result
    }
...
#line 64 "parser.y" /* yacc.c:1646  */
    {
        char *result = malloc(10);
        sprintf(result, "t%d", ++temp_count);
        generate_code("-", "0", (yyvsp[0].str), result);
        (yyval.str) = result; // Set $$ to result
    }
...
#line 70 "parser.y" /* yacc.c:1646  */
    {
        (yyval.str) = (yyvsp[-1].str); // Just return the inner expression
    }
...
#line 73 "parser.y" /* yacc.c:1646  */
    {
        (yyval.str) = strdup((yyvsp[0].str)); // Return a copy of the identifier
    }
...
#line 76 "parser.y" /* yacc.c:1646  */
    {
        char *result = malloc(10);
        sprintf(result, "%d", (yyvsp[0].num)); // Convert number to string
        (yyval.str) = result; // Return the number
    }
